...
/**
 * BasOrgGroupOrgCopyCopy 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface BasOrgGroupOrgCopyCopyRepository
    extends BasOrgGroupOrgCopyCopyRepositoryCustom,
        PagodaJpaRepository<BasOrgGroupOrgCopyCopy, Long> {
