...
/**
 * BasOrgGroupOrgCopy 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface BasOrgGroupOrgCopyRepository
    extends BasOrgGroupOrgCopyRepositoryCustom, PagodaJpaRepository<BasOrgGroupOrgCopy, Long> {
