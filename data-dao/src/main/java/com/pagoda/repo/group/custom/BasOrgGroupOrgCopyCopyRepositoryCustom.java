...
/**
 * BasOrgGroupOrgCopyCopy扩展数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface BasOrgGroupOrgCopyCopyRepositoryCustom {
   ...
   * @return
   */
  List<BasOrgGroupOrgCopyCopyDTO> findBy(
      @Param("orgGroupCode") String orgGroupCode,
      @Param("orgGroupId") Long orgGroupId,
      @Param("orgGroupName") String orgGroupName,
      @Param("orgOrgCode") String orgOrgCode,
   ...
   * @return
   */
  List<BasOrgGroupOrgCopyCopyDTO> findByExample(@Param("example") BasOrgGroupOrgCopyCopy example);
   ...
   * @return
   */
  Page<BasOrgGroupOrgCopyCopyDTO> findByBuilder(
   ...
   * @return
   */
  List<BasOrgGroupOrgCopyCopyDTO> findByBuilder(@Param("builder") JpaQueryBuilder builder);
   ...
   * @return
   */
  Page<BasOrgGroupOrgCopyCopyDTO> findByFuzzySearch(
   ...
   */
  Page<BasOrgGroupOrgCopyCopyDTO> findByField(
   ...
   * @throws IllegalAccessException
   */
  List<BasOrgGroupOrgCopyCopyDTO> findByField(
