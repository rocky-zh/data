...
public class SalConsignHeadDynamicSqlSupport {
  ...
  public static SqlColumn<String> no = salConsignHeadTable.no;
  ...
  public static SqlColumn<java.math.BigDecimal> totalWeight = salConsignHeadTable.totalWeight;
  ...
  public static SqlColumn<Boolean> active = salConsignHeadTable.active;
  ...
  public static final class SalConsignHeadTable extends SqlTable {
    ...
    public final SqlColumn<java.math.BigDecimal> totalWeight =
        column("total_weight", JDBCType.DECIMAL);
