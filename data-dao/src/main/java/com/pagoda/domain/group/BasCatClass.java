...
public class BasCatClass extends BasCatClassDTO implements Serializable {
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "字符串   COMMENT '全名'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "字符串   COMMENT '是否子节点'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "整型   COMMENT '层级数'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "字符串   COMMENT '父目录分类代码'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "整型   COMMENT '父目录分类Id'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "字符串   COMMENT '父目录分类名称'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "字符串   COMMENT '物化路径'"
  )
  private String path;
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "整型   COMMENT '来源Id'"
  )
