...
public class InvDepot extends InvDepotDTO implements Serializable {
  ...
  @Column(
    name = "\"create_org_code\"",
    nullable = true,
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(15)   COMMENT '创建用户部门代码'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(20)   COMMENT '创建用户代码'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(20)   COMMENT '创建用户名称'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER   COMMENT ' 删除次数'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(60)   COMMENT '库房地址'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(30)   COMMENT '联系电话'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(15)   COMMENT '所属往来单位代码'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(60)   COMMENT '所属往来单位名称'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "TIMESTAMP   COMMENT '最后一次修改时间'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(15)   COMMENT '最后一次修改用户用户部门代码'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(15)   COMMENT '最后一次修改用户代码'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(60)   COMMENT '最后一次修改用户名称'"
  )
