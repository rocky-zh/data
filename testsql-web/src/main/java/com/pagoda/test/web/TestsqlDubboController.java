...
@Slf4j
public class TestsqlDubboController {

  /** 模块名 * */
  public static final String MODULE_NAME = "Testsql";
  ...
  static {
    putInMap(DTO_PACKAGES, "com.pagoda.test.api.dto.group.inv_check_stock_headDTO");
  }
  ...
  static {
    putInMap(API_PACKAGES, "com.pagoda.test.api.group.inv_check_stock_headService");
  }
