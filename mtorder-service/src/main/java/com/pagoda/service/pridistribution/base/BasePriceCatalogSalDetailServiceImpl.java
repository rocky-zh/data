...
public abstract class BasePriceCatalogSalDetailServiceImpl
  ...
  @ApiOperation(value = "findPriceAdjustLogs", notes = "")
  @Override
  public Page<FindPriceAdjustLogsDTO> findPriceAdjustLogs(
      @ApiParam("price_cat_id") Long priceCatId,
      @ApiParam("goods_id") Long goodsId,
      @ApiParam("pageable") Pageable pageable)
      throws ServiceException {
    try {
      return repository.findPriceAdjustLogs(priceCatId, goodsId, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
