...
public abstract class BasePriceAdjustSalDetailServiceImpl
  ...
  @ApiOperation(value = "findSalPriceAndReturnPrice", notes = "查询配送退货价")
  @Override
  public Page<FindSalPriceAndReturnPriceDTO> findSalPriceAndReturnPrice(
      ...
      throws ServiceException {
    try {
      return repository.findSalPriceAndReturnPrice(
          orgOrgCode,
          orgOrgName,
          cusOrgCode,
          cusOrgName,
