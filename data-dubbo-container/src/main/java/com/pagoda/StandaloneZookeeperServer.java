...
/**
 * 嵌入式zookeeper，用于测试 https://github.com/leonzm/zk_demo
 *
...
public class StandaloneZookeeperServer {
   ...
   */
  public static void startStandaloneServer1(
      String tickTime, String dataDir, String clientPort, String initLimit, String syncLimit) {
   ...
   */
  public static void startStandaloneServer2(
      String tickTime, String dataDir, String clientPort, String maxcnxn) {
    ZooKeeperServerMain.main(
        new String[] {
          clientPort, dataDir, tickTime, maxcnxn
        }); // port datadir [ticktime] [maxcnxns]"
  }

  public static void main(String[] args) throws Exception {
    startStandaloneServer1(
        "2000",
        new File(System.getProperty("java.io.tmpdir"), "zookeeper").getAbsolutePath(),
        "2181",
        "10",
        "5");
    // startStandaloneServer2("2000", new File(System.getProperty("java.io.tmpdir"),
    // "zookeeper").getAbsolutePath(), "2181", "44");
  }
}
