...
@Slf4j
public class PersonDubboController {

  /** 模块名 * */
  public static final String MODULE_NAME = "Person";

  /** 模块包名 * */
  public static final String MODULE_PACKAGE = "com.test";

  /** DTO包名 * */
  public static final Map<String, String> DTO_PACKAGES = new HashMap<>();

  static {
    putInMap(DTO_PACKAGES, "com.test.api.dto.group.PersonDTO");
  }
  ...
  static {
    putInMap(API_PACKAGES, "com.test.api.group.PersonService");
  }
