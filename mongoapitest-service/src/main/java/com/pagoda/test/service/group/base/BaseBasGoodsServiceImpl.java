...
public abstract class BaseBasGoodsServiceImpl implements BaseBasGoodsService, InitializingBean {
  ...
  @Override
  public Page<BasGoodsDTO> simpleListQuery(
      @ApiParam("idList") List<Long> idList, @ApiParam("pageable") Pageable pageable)
      throws ServiceException {
    try {
  ...
  @Override
  public Page<SelectVenGoodsDetailUnSetDTO> selectVenGoodsDetailUnSet(
      ...
      throws ServiceException {
    try {
      return repository.selectVenGoodsDetailUnSet(
          tableId, catClassId, catId, goodsIds, goodsId, isEnabled, deleted, entId, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
  ...
  @Override
  public Page<BasGoodsDTO> selectWithList(
      @ApiParam("idList") List<Long> idList,
      @ApiParam("code") String code,
      @ApiParam("pageable") Pageable pageable)
      throws ServiceException {
    try {
      return repository.selectWithList(idList, code, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
