...
@ApiModel(value = "BasOrgGroupOrgCopyDTO", description = "虚拟机构组对应机构明细表")
@EntityFeature(
  entityName = "BasOrgGroupOrgCopyDTO",
  idField = "id",
  persistent = true,
  generationType = "auto",
  batchImport = false,
...
public class BasOrgGroupOrgCopyDTO implements Serializable {
  ...
  @ApiModelProperty(
    ...
    value = "虚拟机构组代码",
    dataType = "字符串",
    notes = "5b30b3567c51e0fcf53ec4ab"
  )
  ...
  @ApiModelProperty(
    ...
    value = "虚拟机构组ID",
    dataType = "长整型",
    notes = "5b30b3567c51e0fcf53ec4af"
  )
  ...
  @ApiModelProperty(
    ...
    value = "虚拟机构组名称",
    dataType = "字符串",
    notes = "5b30b3567c51e0fcf53ec4ad"
  )
  ...
  @ApiModelProperty(
    ...
    value = "机构代码",
    dataType = "字符串",
    notes = "5b30b3567c51e0fcf53ec4b5"
  )
  ...
  @ApiModelProperty(
    ...
    value = "机构ID",
    dataType = "长整型",
    notes = "5b30b3567c51e0fcf53ec4b1"
  )
  ...
  @ApiModelProperty(
    ...
    value = "机构名称",
    dataType = "字符串",
    notes = "5b30b3567c51e0fcf53ec4b3"
  )
