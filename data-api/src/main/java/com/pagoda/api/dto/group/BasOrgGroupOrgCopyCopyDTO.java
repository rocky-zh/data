...
@ApiModel(value = "BasOrgGroupOrgCopyCopyDTO", description = "虚拟机构组对应机构明细表")
@EntityFeature(
  entityName = "BasOrgGroupOrgCopyCopyDTO",
  idField = "id",
  persistent = true,
  generationType = "auto",
  batchImport = false,
...
public class BasOrgGroupOrgCopyCopyDTO implements Serializable {
