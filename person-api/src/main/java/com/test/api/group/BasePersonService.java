...
public interface BasePersonService {
  ...
  PersonDTO create(@ApiParam(value = "entity", required = true) @Valid PersonDTO entity)
      throws ServiceException;
  ...
  Iterable<PersonDTO> batchCreate(
  ...
  PersonDTO update(@ApiParam(value = "entity", required = true) PersonDTO entity)
      throws ServiceException;
  ...
  Iterable<PersonDTO> batchUpdate(
  ...
  Page<PersonDTO> findBy(
      @ApiParam("orderTime") java.sql.Time orderTime, @ApiParam("pageable") Pageable pageable)
      throws ServiceException;
  ...
  Page<PersonDTO> selectWithTime(
      @ApiParam("order_time") java.sql.Time orderTime,
