 ...
 * @generated
 */
public interface SalOrderControlRepository
    extends BaseSalOrderControlRepository,
        SalOrderControlRepositoryCustom,
        PagodaJpaRepository<SalOrderControl, Long> {}
