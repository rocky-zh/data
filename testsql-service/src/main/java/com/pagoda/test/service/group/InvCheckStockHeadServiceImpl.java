...
import static com.pagoda.test.domain.group.sql.InvCheckStockHeadDynamicSqlSupport.*;
...
/**
 * 盘点单头表服务实现类InvCheckStockHeadServiceImpl，可以添加自定义的业务实现。
 *
 * @author ???
 */
@Service
@Validated
public class InvCheckStockHeadServiceImpl extends BaseInvCheckStockHeadServiceImpl {}
