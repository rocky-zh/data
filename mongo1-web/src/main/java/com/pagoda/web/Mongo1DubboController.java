...
@Slf4j
public class Mongo1DubboController {

  /** 模块名 * */
  public static final String MODULE_NAME = "Mongo1";
  ...
  static {
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.group.BasTestGoodsDataDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.group.BasTestGoodsDTO");
  }
  ...
  static {
    putInMap(API_PACKAGES, "com.pagoda.api.group.BasTestGoodsDataService");
    putInMap(API_PACKAGES, "com.pagoda.api.group.BasTestGoodsService");
  }
