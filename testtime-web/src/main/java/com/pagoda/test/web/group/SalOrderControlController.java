...
public class SalOrderControlController implements InitializingBean {
  ...
  public Page<SalOrderControlDTO> findBy(
      ...
      @RequestParam(required = false, value = "placeOrderTime") java.sql.Time placeOrderTime,
      @RequestParam(required = false, value = "placeOrderTime2") java.sql.Timestamp placeOrderTime2,
