 ...
 */
@NoRepositoryBean
public interface BaseBasGoodsRepository
   ...
   */
  @SqlTemplate(
    name = "simpleListQuery",
    sql =
        "select * from bas_goods where id in ({{#idList}}{{^-first}}, {{/-first}}{{this}}{{/idList}})"
  )
  Page<BasGoodsDTO> simpleListQuery(
      @Param("idList") List<Long> idList, @Param("pageable") Pageable pageable);
  ...
  List<SelectVenGoodsDetailUnSetDTO> selectVenGoodsDetailUnSet(
      @Param("table_id") Long tableId,
      @Param("cat_class_id") String catClassId,
      @Param("cat_id") Long catId,
      @Param("goodsIds") List<Long> goodsIds,
  ...
  @SqlTemplate(
    name = "selectWithList",
    sql =
        "select * from bas_goods where {{#idList_exists}}id in ({{#idList}}{{^-first}}, {{/-first}}{{this}}{{/idList}}){{/idList_exists}}{{#code}} and code= :code{{/code}}"
  )
  Page<BasGoodsDTO> selectWithList(
  ...
  List<BasGoodsDTO> selectWithList(@Param("idList") List<Long> idList, @Param("code") String code);
