 ...
 */
@Validated
public interface BaseBasTestGoodsDataService {
  ...
  Iterable<BasTestGoodsDataDTO> batchCreate(
  ...
  Iterable<BasTestGoodsDataDTO> batchUpdate(
  ...
  BasTestGoodsDataDTO getById(@ApiParam(value = "id", required = true) Long id)
      throws ServiceException;
  ...
  Iterable<BasTestGoodsDataDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
  ...
  Page<BasTestGoodsDataDTO> selectWithTime(@ApiParam("pageable") Pageable pageable)
      throws ServiceException;
}
