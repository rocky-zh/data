...
public interface BaseBasGoodsService {
    ...
    BasGoodsDTO create(@ApiParam(value = "entity", required = true) @Valid BasGoodsDTO entity) throws ServiceException;
    ...
    Iterable<BasGoodsDTO> batchCreate(@ApiParam(value = "entities", required = true) @Valid Iterable<BasGoodsDTO> entities) throws ServiceException;
    ...
    BasGoodsDTO update(@ApiParam(value = "entity", required = true) BasGoodsDTO entity) throws ServiceException;
    ...
    Iterable<BasGoodsDTO> batchUpdate(@ApiParam(value = "entities", required = true) Iterable<BasGoodsDTO> entities) throws ServiceException;
    ...
    */
    ...
    Iterable<BasGoodsDTO> batchGetByIds(@ApiParam("idList") List<Long> idList) throws ServiceException;
 ...
 /**
  ...
  Page<BasGoodsDTO> findByExample(@ApiParam("example") BasGoodsDTO example,  @ApiParam("pageable") Pageable pageable)  throws ServiceException;
   ...
   */
     ...
     * @throws ServiceException
     */
    @ApiOperation(value = "simpleListQuery", notes = "")
    Page<BasGoodsDTO> simpleListQuery(@ApiParam("idList") List<Long> idList, @ApiParam("pageable") Pageable pageable) throws ServiceException;
     ...
     * @throws ServiceException
     */
    @ApiOperation(value = "selectVenGoodsDetailUnSet", notes = "")
    Page<SelectVenGoodsDetailUnSetDTO> selectVenGoodsDetailUnSet(@ApiParam("table_id") Long tableId, @ApiParam("cat_class_id") String catClassId, @ApiParam("cat_id") Long catId, @ApiParam("goodsIds") List<Long> goodsIds, @ApiParam("goods_id") String goodsId, @ApiParam("is_enabled") Integer isEnabled, @ApiParam("deleted") Long deleted, @ApiParam("ent_id") Long entId, @ApiParam("pageable") Pageable pageable) throws ServiceException;
     ...
     * @throws ServiceException
     */
    @ApiOperation(value = "selectWithList", notes = "")
    Page<> selectWithList(@ApiParam("pageable") Pageable pageable) throws ServiceException;
