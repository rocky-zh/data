...
public class SalOrderControlDynamicSqlSupport {
    ...
    public static SqlColumn<java.math.BigDecimal> allowSafetyStockTimes = salOrderControlTable.allowSafetyStockTimes;
    ...
    public static SqlColumn<> placeOrderTime = salOrderControlTable.placeOrderTime;
    public static SqlColumn<> placeOrderTime2 = salOrderControlTable.placeOrderTime2;
    public static SqlColumn<Integer> isCtrlReturn = salOrderControlTable.isCtrlReturn;
    public static SqlColumn<> returnGoodsTime1 = salOrderControlTable.returnGoodsTime1;
    public static SqlColumn<> returnGoodsTime2 = salOrderControlTable.returnGoodsTime2;
    ...
    public static final class SalOrderControlTable extends SqlTable {
        ...
        public final SqlColumn<Integer> isCtrlVrfyTrans = column("is_ctrl_vrfy_trans", JDBCType.INTEGER);
        ...
        public final SqlColumn<Integer> isCtrlRouteSplit = column("is_ctrl_route_split", JDBCType.INTEGER);
        public final SqlColumn<Integer> isCtrlSafetyStock = column("is_ctrl_safety_stock", JDBCType.INTEGER);
        public final SqlColumn<java.math.BigDecimal> allowSafetyStockTimes = column("allow_safety_stock_times", JDBCType.DECIMAL);
        public final SqlColumn<Integer> isCtrlExeBatchPolicy = column("is_ctrl_exe_batch_policy", JDBCType.INTEGER);
        public final SqlColumn<Integer> isCtrlOneOrder = column("is_ctrl_one_order", JDBCType.INTEGER);
        public final SqlColumn<> placeOrderTime = column("place_order_time", JDBCType.VARCHAR);
        public final SqlColumn<> placeOrderTime2 = column("place_order_time2", JDBCType.VARCHAR);
        public final SqlColumn<Integer> isCtrlReturn = column("is_ctrl_return", JDBCType.INTEGER);
        public final SqlColumn<> returnGoodsTime1 = column("return_goods_time1", JDBCType.VARCHAR);
        public final SqlColumn<> returnGoodsTime2 = column("return_goods_time2", JDBCType.VARCHAR);
