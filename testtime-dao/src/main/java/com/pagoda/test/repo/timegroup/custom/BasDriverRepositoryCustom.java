 ...
 * @generated
 */
public interface BasDriverRepositoryCustom {
   ...
   * @return
   */
  List<BasDriverDTO> findByExample(@Param("example") BasDriver example);
   ...
   * @return
   */
  Page<BasDriverDTO> findByBuilder(
   ...
   * @return
   */
  List<BasDriverDTO> findByBuilder(@Param("builder") JpaQueryBuilder builder);
   ...
   * @return
   */
  Page<BasDriverDTO> findByFuzzySearch(
   ...
   * @throws IllegalAccessException
   */
  List<BasDriverDTO> findByField(@Param("fieldName") String fieldName, @Param("value") Object value)
      throws NoSuchFieldException, IllegalAccessException;
}
