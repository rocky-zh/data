...
public class PurOrgVenController implements InitializingBean {
  ...
  public Page<PurOrgVenDTO> findBy(
      ...
      @RequestParam(required = false, value = "venClassId") Long venClassId,
      @RequestParam(required = false, value = "venClassName") String venClassName,
      @RequestParam(required = false, value = "venClassCode") String venClassCode,
