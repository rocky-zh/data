...
public class MtorderDubboController {
  ...
  static {
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.purapply.pur_apply_detailDTO");
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.pridistribution.sal_org_cusDTO");
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.purorder.pur_order_detailDTO");
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.purapply.pur_apply_headDTO");
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.purorder.pur_order_headDTO");
  ...
  static {
    putInMap(API_PACKAGES, "com.pagoda.api.purapply.pur_apply_detailService");
    putInMap(API_PACKAGES, "com.pagoda.api.pripurchase.price_adjust_pur_headService");
    putInMap(API_PACKAGES, "com.pagoda.api.purorder.pur_order_headService");
    ...
    putInMap(API_PACKAGES, "com.pagoda.api.purapply.pur_apply_headService");
    ...
    putInMap(API_PACKAGES, "com.pagoda.api.pridistribution.sal_org_cusService");
    putInMap(API_PACKAGES, "com.pagoda.api.salorderhead.sal_order_detail_goods_qtyService");
    putInMap(API_PACKAGES, "com.pagoda.api.purorder.pur_order_detailService");
