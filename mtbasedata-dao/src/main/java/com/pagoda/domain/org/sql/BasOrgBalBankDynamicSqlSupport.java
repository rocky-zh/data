...
public class BasOrgBalBankDynamicSqlSupport {
  ...
  public static SqlColumn<Long> balOrgId = basOrgBalBankTable.balOrgId;
  public static SqlColumn<Integer> isDefault = basOrgBalBankTable.isDefault;
  public static SqlColumn<String> remark = basOrgBalBankTable.remark;
