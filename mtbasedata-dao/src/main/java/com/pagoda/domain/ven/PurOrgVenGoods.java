...
public class PurOrgVenGoods extends PurOrgVenGoodsDTO implements Serializable {
  ...
  @FieldMeta(
    name = "unitRate",
    scene = "",
    nameCN = "计量单位比率(和最小单位比较的值)",
    comment = "计量单位比率(和最小单位比较的值)",
    nameEN = "unit_rate",
    type = "小数",
    format = "",
    displayLen = 1,
  ...
  @Column(
    ...
    precision = 0,
    scale = 6,
    columnDefinition = "decimal(18,10)   COMMENT '计量单位比率(和最小单位比较的值)'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 6,
    columnDefinition = "decimal(18,10)   COMMENT '单价[根据商品信息自动带出，来源价格管理中当天的最新商品配送价格数据，不能修改]'"
  )
