...
@EntityFeature(
  ...
  requestUrl = "/BasGoodsService/findGoodsInDefine",
...
public class BasGoods extends BasGoodsDTO implements Serializable {
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER  NOT NULL   COMMENT '商品类型{可选值集数据字典}'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "BIGINT  NOT NULL   COMMENT '库存单位ID'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(35)  NOT NULL   COMMENT '库存单位代码[冗余]'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 6,
    columnDefinition = "decimal(10,10)  NOT NULL   COMMENT '库存单位转换比(库存单位转为基础单位转换比)'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER  NOT NULL  default 0 COMMENT '是否管理批次(企业级)'"
  )
  private Integer isEntLot = 0;
  ...
  @Column(
    ...
    precision = 0,
    scale = 6,
    columnDefinition = "decimal(18,10)  NOT NULL   COMMENT '保质期数量'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(35)  NOT NULL   COMMENT '行政单位代码'"
  )
  private String code;
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "BIGINT  NOT NULL   COMMENT '基础计量单位ID'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(35)  NOT NULL   COMMENT '基础计量单位代码[冗余]'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(60)  NOT NULL   COMMENT '基本单位名称[冗余]'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(60)  NOT NULL   COMMENT '销售单位名称[冗余]'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER  NOT NULL  default 1 COMMENT '是否可用'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER  NOT NULL  default 1 COMMENT '是否可订(采购)[采购按主商品采购]'"
  )
  private Integer isPur = 1;
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER  NOT NULL  default 1 COMMENT '是否允许销售(b2b用)'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER  NOT NULL  default 1 COMMENT '是否零售(b2c用，另因按订单退，故无需是否允许退货)'"
  )
  private Integer isRet = 1;
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "varchar(60)  default '“”' COMMENT '助记码'"
  )
  ...
  public static BasGoods toExample() {
    ...
    example.isEntLot = null;
    example.isEnabled = null;
    example.isPur = null;
    example.isSale = null;
    example.isRet = null;
    example.mnemWord = null;
    return example;
  }
