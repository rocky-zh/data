...
public class BasOrgGoods extends BasOrgGoodsDTO implements Serializable {
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "BIGINT   COMMENT '默认采购退货出库库房'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "BIGINT   COMMENT '默认采购进货入库库房'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 6,
    columnDefinition = "decimal(18,10)   COMMENT '批量数量'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "INTEGER   COMMENT '批量政策{0:无,1:固定倍数,2:最小起订量}'"
  )
