...
/**
 * BasGoodsBomHead扩展数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface BasGoodsBomHeadRepositoryCustom {
   ...
   * @return
   */
  Page<BasGoodsBomHeadDTO> findBy(
   ...
   * @return
   */
  List<BasGoodsBomHeadDTO> findBy(
      @Param("inDepotId") Long inDepotId,
      @Param("inDepotName") String inDepotName,
      @Param("name") String name,
      @Param("searchWord") String searchWord,
   ...
   * @return
   */
  Page<BasGoodsBomHeadDTO> findByExample(
   ...
   * @return
   */
  List<BasGoodsBomHeadDTO> findByExample(@Param("example") BasGoodsBomHead example);
   ...
   * @return
   */
  Page<BasGoodsBomHeadDTO> findByBuilder(
   ...
   * @return
   */
  List<BasGoodsBomHeadDTO> findByBuilder(@Param("builder") JpaQueryBuilder builder);
   ...
   * @return
   */
  Page<BasGoodsBomHeadDTO> findByFuzzySearch(
   ...
   */
  Page<BasGoodsBomHeadDTO> findByField(
   ...
   * @throws IllegalAccessException
   */
  List<BasGoodsBomHeadDTO> findByField(
