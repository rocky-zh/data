...
/**
 * BasGoodsClassCodeRule扩展数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface BasGoodsClassCodeRuleRepositoryCustom {
   ...
   * @return
   */
  List<BasGoodsClassCodeRuleDTO> findBy(
      @Param("codeRuleId") Long codeRuleId,
      @Param("name") String name,
      @Param("goodsClassId") Long goodsClassId,
      @Param("goodsClassCode") String goodsClassCode,
   ...
   * @return
   */
  List<BasGoodsClassCodeRuleDTO> findByExample(@Param("example") BasGoodsClassCodeRule example);
   ...
   * @return
   */
  Page<BasGoodsClassCodeRuleDTO> findByBuilder(
   ...
   * @return
   */
  List<BasGoodsClassCodeRuleDTO> findByBuilder(@Param("builder") JpaQueryBuilder builder);
   ...
   * @return
   */
  Page<BasGoodsClassCodeRuleDTO> findByFuzzySearch(
   ...
   */
  Page<BasGoodsClassCodeRuleDTO> findByField(
   ...
   * @throws IllegalAccessException
   */
  List<BasGoodsClassCodeRuleDTO> findByField(
