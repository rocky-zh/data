...
/**
 * BasGoodsUnit扩展数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface BasGoodsUnitRepositoryCustom {
   ...
   * @return
   */
  List<BasGoodsUnitDTO> findByExample(@Param("example") BasGoodsUnit example);
   ...
   * @return
   */
  Page<BasGoodsUnitDTO> findByBuilder(
   ...
   * @return
   */
  List<BasGoodsUnitDTO> findByBuilder(@Param("builder") JpaQueryBuilder builder);
   ...
   * @return
   */
  Page<BasGoodsUnitDTO> findByFuzzySearch(
   ...
   */
  Page<BasGoodsUnitDTO> findByField(
   ...
   * @throws IllegalAccessException
   */
  List<BasGoodsUnitDTO> findByField(
