...
/**
 * BasGoodsProcessDetail 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface BasGoodsProcessDetailRepository
    extends BasGoodsProcessDetailRepositoryCustom,
        PagodaJpaRepository<BasGoodsProcessDetail, Long> {
