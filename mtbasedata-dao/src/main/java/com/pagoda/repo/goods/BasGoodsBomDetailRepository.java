...
/**
 * BasGoodsBomDetail 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface BasGoodsBomDetailRepository
    extends BasGoodsBomDetailRepositoryCustom, PagodaJpaRepository<BasGoodsBomDetail, Long> {
