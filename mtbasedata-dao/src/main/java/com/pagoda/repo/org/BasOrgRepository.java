...
public interface BasOrgRepository
  ...
  @SqlTemplate(
    ...
    sql =
        "select * from bas_org where id in({{#org_org_ids}}org_org_ids{{/org_org_ids}}) and {{#deleted}}deleted=:deleted and {{/deleted}} {{#ent_id}}ent_id=:ent_id and {{/ent_id}} 1=1"
  )
