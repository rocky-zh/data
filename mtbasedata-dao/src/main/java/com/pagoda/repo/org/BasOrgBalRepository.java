 ...
 * @generated
 */
public interface BasOrgBalRepository
    extends BasOrgBalRepositoryCustom, PagodaJpaRepository<BasOrgBal, Long> {
  ...
  @SqlTemplate(
    name = "deleteByOrgId",
    sql = "update bas_org_bal set deleted = id where org_id=:org_id"
  )
  @Modifying
