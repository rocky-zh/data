 ...
 * @generated
 */
public interface BasOrgOrgRepository
    extends BasOrgOrgRepositoryCustom, PagodaJpaRepository<BasOrgOrg, Long> {
  ...
  @SqlTemplate(
    name = "deleteByOrgId",
    sql = "update bas_org_org set deleted = id where org_id=:org_id"
  )
  @Modifying
