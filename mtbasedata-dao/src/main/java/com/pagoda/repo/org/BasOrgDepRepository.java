 ...
 * @generated
 */
public interface BasOrgDepRepository
    extends BasOrgDepRepositoryCustom, PagodaJpaRepository<BasOrgDep, Long> {
  ...
  @SqlTemplate(
    name = "deleteByOrgId",
    sql = "update bas_org_dep set deleted = id where org_id=:org_id"
  )
  @Modifying
