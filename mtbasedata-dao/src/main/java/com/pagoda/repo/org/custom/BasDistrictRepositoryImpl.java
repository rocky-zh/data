...
public class BasDistrictRepositoryImpl extends BaseRepositoryCustomImpl<BasDistrict, Long>
  ...
  public Page<BasDistrictDTO> findBy(
      @Param("districtLevel") Integer districtLevel,
      @Param("code") String code,
      @Param("parentCode") String parentCode,
      @Param("name") String name,
      @Param("searchWord") String searchWord,
      @Param("adLat") java.math.BigDecimal adLat,
      @Param("adLng") java.math.BigDecimal adLng,
      @Param("pageable") Pageable pageable) {
    BasDistrict obj = BasDistrict.toExample();
    obj.setDistrictLevel(districtLevel);
    obj.setCode(code);
    obj.setParentCode(parentCode);
    obj.setName(name);
