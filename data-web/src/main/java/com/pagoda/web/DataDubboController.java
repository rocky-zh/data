...
public class DataDubboController {
  ...
  static {
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.分组.FindInvDepotByCatClassDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.分组.inv_depotDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.分组.bas_cat_classDTO");
  }
  ...
  static {
    putInMap(API_PACKAGES, "com.pagoda.api.分组.inv_depotService");
    putInMap(API_PACKAGES, "com.pagoda.api.分组.bas_cat_classService");
  }
