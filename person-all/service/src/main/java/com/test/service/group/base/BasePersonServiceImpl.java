package com.test.service.group.base;
...
public abstract class BasePersonServiceImpl implements BasePersonService, InitializingBean  {
  ...
  public Iterable<PersonDTO> findAll() {
    ...
    @Override
    public PersonDTO create(@ApiParam(value = "entity", required = true) @Valid PersonDTO entity) throws ServiceException {
        try {
    ...
    @Override
    public Iterable<PersonDTO> batchCreate(@ApiParam(value = "entities", required = true) @Valid Iterable<PersonDTO> entities) throws ServiceException {
        try {
    ...
    @Override
    public PersonDTO update(@ApiParam(value = "entity", required = true) PersonDTO entity) throws ServiceException {
        try {
    ...
    @Override
    public Iterable<PersonDTO> batchUpdate(@ApiParam(value = "entities", required = true) Iterable<PersonDTO> entities) throws ServiceException {
        try {
    ...
    @Override
    public PersonDTO getById(@ApiParam(value = "id", required = true) Long id) throws ServiceException {
        try {
    ...
    */
    ...
    @Override
    public Iterable<PersonDTO> batchGetByIds(@ApiParam("idList") List<Long> idList) throws ServiceException {
        try {
    ...
    @Override
    public Page<PersonDTO> findBy(@ApiParam("orderTime")null orderTime, @ApiParam("pageable") Pageable pageable) throws ServiceException {
        try {
            return repository.findBy(orderTime, pageable);
        } catch (Exception e) {
            throw new ServiceException(e);
        }
    }
  ...
  @Override
  public Page<PersonDTO> findByExample(@ApiParam("example") PersonDTO example, @ApiParam("pageable") Pageable pageable) throws ServiceException {
        try {
    ...
    @Override
    public Page<PersonDTO> selectWithTime(@ApiParam("order_time") null orderTime, @ApiParam("idList") List<Long> idList, @ApiParam("pageable") Pageable pageable) throws ServiceException {
        try {
