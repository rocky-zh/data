...
public class PersonDynamicSqlSupport {
  ...
  public static SqlColumn<java.sql.Time> orderTime = personTable.orderTime;
  ...
  public static final class PersonTable extends SqlTable {
    ...
    public final SqlColumn<java.sql.Time> orderTime = column("order_time", JDBCType.VARCHAR);
