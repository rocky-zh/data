...
@EntityFeature(entityName="Person", idField="id", persistent=true, generationType="auto", batchImport=false, treeStyle=false, auditable=false, traceable=false, approvalRequired=false, requestUrl="", tableMultiSelect=false)
public class Person extends PersonDTO implements Serializable {
    ...
    @FieldMeta(name="orderTime", scene="订单时间", nameCN="orderTime", comment="orderTime", nameEN="orderTime", type="时分秒", format="", displayLen=1, formSize="", constraint="", constraintParams="",
        ...
        @Column(name = "\"order_time\"" , nullable=true , precision=0, scale=0, columnDefinition="VARCHAR   COMMENT 'orderTime'")
    private  orderTime ;
    ...
    public static Converter<Person, PersonDTO> DTO_CONVERTER = new Converter<Person, PersonDTO>() {
