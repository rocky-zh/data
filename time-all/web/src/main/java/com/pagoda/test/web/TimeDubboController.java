...
@Slf4j
public class TimeDubboController implements InitializingBean {

  /** 模块名 * */
  public static final String MODULE_NAME = "Time";

  /** 模块包名 * */
  public static final String MODULE_PACKAGE = "com.pagoda.test";
  ...
  static {
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.test.api.dto.timegroup.PersonDTO");
  }
  ...
  static {
    ...
    putInMap(API_PACKAGES, "com.pagoda.test.api.timegroup.PersonService");
  }
  ...
  static {
    ...
    ENTITY_DTO_MAPPING.put(
        "com.pagoda.test.domain.timegroup.Person", "com.pagoda.test.api.dto.timegroup.PersonDTO");
  }
