...
/**
 * 往来单位-015 结算机构明细表[注：开户行管理，不加字段，是取bas_org_bal_bank中默认的银行]服务实现类BasOrgBalServiceImpl继承的父类,实现一些平台共用的方法
 *
...
public abstract class BaseBasOrgBalServiceImpl implements BasOrgBalService, InitializingBean {
  ...
  @ApiOperation(value = "deleteByOrgId", notes = "删除结算单位信息 通过往来单位id")
  @Override
