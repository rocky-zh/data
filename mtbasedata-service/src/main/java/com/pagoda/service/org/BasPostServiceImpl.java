...
import static com.pagoda.domain.org.sql.BasPostDynamicSqlSupport.*;
...
/**
 * 岗位表 服务实现类BasPostServiceImpl，可以添加自定义的业务实现。
 *
 * @author ???
 */
@Service
@Validated
public class BasPostServiceImpl extends BaseBasPostServiceImpl {}
