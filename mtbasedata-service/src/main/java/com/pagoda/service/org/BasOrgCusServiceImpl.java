...
import static com.pagoda.domain.org.sql.BasOrgCusDynamicSqlSupport.*;
...
/**
 * 往来单位-012 客户明细表服务实现类BasOrgCusServiceImpl，可以添加自定义的业务实现。
 *
 * @author ???
 */
@Service
@Validated
public class BasOrgCusServiceImpl extends BaseBasOrgCusServiceImpl {}
