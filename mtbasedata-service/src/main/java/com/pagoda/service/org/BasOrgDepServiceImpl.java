...
import static com.pagoda.domain.org.sql.BasOrgDepDynamicSqlSupport.*;
...
/**
 * 往来单位-部门明细表服务实现类BasOrgDepServiceImpl，可以添加自定义的业务实现。
 *
 * @author ???
 */
@Service
@Validated
public class BasOrgDepServiceImpl extends BaseBasOrgDepServiceImpl {}
