...
import static com.pagoda.domain.org.sql.BasOrgOrgDynamicSqlSupport.*;
...
/**
 * 往来单位-机构明细表服务实现类BasOrgOrgServiceImpl，可以添加自定义的业务实现。
 *
 * @author ???
 */
@Service
@Validated
public class BasOrgOrgServiceImpl extends BaseBasOrgOrgServiceImpl {}
