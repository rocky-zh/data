...
public class PersonController implements InitializingBean {
  ...
  public Page<PersonDTO> findBy(
      @RequestParam(required = false, value = "zid") Long zid,
      @RequestParam(required = false, value = "tid") Long tid,
      @RequestParam(required = false, value = "loginDateTime") java.util.Date loginDateTime,
      @RequestParam(required = false, value = "orderDate") java.util.Date orderDate,
      @RequestParam(required = false, value = "orderTime") java.util.Date orderTime,
      @RequestParam(required = false, value = "logoutTime") java.util.Date logoutTime,
      @RequestParam(required = false, value = "pageable") Pageable pageable) {
    return personService.findBy(
        zid, tid, loginDateTime, orderDate, orderTime, logoutTime, pageable);
  }
}
