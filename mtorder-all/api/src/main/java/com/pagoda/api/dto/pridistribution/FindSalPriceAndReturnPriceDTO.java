...
@ApiModel(value = "FindSalPriceAndReturnPriceDTO", description = "查询配送退货价")
@EntityFeature(
  entityName = "FindSalPriceAndReturnPriceDTO",
  persistent = false,
  requestUrl = "",
  tableMultiSelect = false
)
public class FindSalPriceAndReturnPriceDTO implements Serializable {
  @FieldMeta(
    name = "modifierName",
    scene = "",
    nameCN = "最后修改人名称",
