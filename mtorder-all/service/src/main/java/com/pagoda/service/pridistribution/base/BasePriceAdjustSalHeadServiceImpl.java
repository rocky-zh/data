...
public abstract class BasePriceAdjustSalHeadServiceImpl
  ...
  @ApiOperation(value = "findPriceAdjustHead", notes = "查询调价单表头")
  @Override
  public Page<FindPriceAdjustHeadDTO> findPriceAdjustHead(
      @ApiParam("ph_id") String phId,
      @ApiParam("soc_id") String socId,
      @ApiParam("pageable") Pageable pageable)
      throws ServiceException {
    try {
      return repository.findPriceAdjustHead(phId, socId, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }

  @ApiOperation(value = "findLogstableHead", notes = "查询调价日志表头")
  @Override
  public Page<FindLogstableHeadDTO> findLogstableHead(
      @ApiParam("soc_id") String socId,
      @ApiParam("ph_id") String phId,
      ...
      throws ServiceException {
    try {
      return repository.findLogstableHead(socId, phId, pdId, goodsId, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
