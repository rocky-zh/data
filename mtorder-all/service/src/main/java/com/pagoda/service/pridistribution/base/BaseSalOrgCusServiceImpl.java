...
public abstract class BaseSalOrgCusServiceImpl implements BaseSalOrgCusService, InitializingBean {
  ...
  public Page<SalOrgCusDTO> findIsSetSalOrgCusList(
      ...
      throws ServiceException {
    try {
      return repository.findIsSetSalOrgCusList(orgOrgCode, cusOrgCodeList, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
  ...
  public Page<SalOrgCusDTO> findAllSalOrgCusList(
      ...
      throws ServiceException {
    try {
      return repository.findAllSalOrgCusList(orgOrgCode, cusOrgCodeList, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
  ...
  public Page<SalOrgCusDTO> findNoSetSalOrgCusList(
      ...
      throws ServiceException {
    try {
      return repository.findNoSetSalOrgCusList(orgOrgCode, cusOrgCodeList, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }

  @ApiOperation(value = "selectCusOrgRelDetail", notes = "客户机构关系列表查询")
  @Override
  public Page<SalOrgCusDTO> selectCusOrgRelDetail(
      ...
      throws ServiceException {
    try {
      return repository.selectCusOrgRelDetail(
          cusList,
          orgList,
          balOrgList,
          balCusList,
