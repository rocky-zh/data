package com.pagoda.service.driverdata.base;
...
public abstract class BaseBasDriverServiceImpl implements BaseBasDriverService, InitializingBean {
  ...
  @ApiOperation(value = "findBasDriverList", notes = "查询司机定义列表")
  @Override
  public Page<BasDriverDTO> findBasDriverList(
      @ApiParam("code") String code,
      @ApiParam("name") String name,
      @ApiParam("enabled") Integer enabled,
      @ApiParam("conOrgId") Long conOrgId,
      ...
      throws ServiceException {
    try {
      return repository.findBasDriverList(
          code, name, enabled, conOrgId, mobile, creatorOrgCode, codeList, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
