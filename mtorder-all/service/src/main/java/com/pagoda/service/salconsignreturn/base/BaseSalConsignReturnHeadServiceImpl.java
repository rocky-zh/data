...
public abstract class BaseSalConsignReturnHeadServiceImpl
  ...
  @ApiOperation(value = "findEntryCompletedReturnHead", notes = "查询状态为录入完成以后得退货单")
  @Override
  public Page<SalConsignReturnHeadDTO> findEntryCompletedReturnHead(
      @ApiParam("status") Integer status,
      @ApiParam("seqno") String seqno,
      @ApiParam("arr_org_code") String arrOrgCode,
      @ApiParam("arr_org_name") String arrOrgName,
      ...
      throws ServiceException {
    try {
      return repository.findEntryCompletedReturnHead(
          status,
          seqno,
          arrOrgCode,
          arrOrgName,
