...
public abstract class BaseBasVenRebateGoodsDetailServiceImpl
  ...
  @ApiOperation(value = "selectVenRebateGoodsDetailAuthored", notes = "查询已授权的供应商机构返利商品明细")
  @Override
  public Page<BasVenRebateGoodsDetailDTO> selectVenRebateGoodsDetailAuthored(
      ...
      throws ServiceException {
    try {
      return repository.selectVenRebateGoodsDetailAuthored(
          goodsClassId, goodsName, goodsCode, status, entId, deleted, pageable);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }

  @ApiOperation(value = "updateGoodsDetailStatusByRebateId", notes = "通过协议号id更新商品明细状态")
  @Override
  @Transactional(rollbackFor = ServiceException.class)
  public Integer updateGoodsDetailStatusByRebateId(
      @ApiParam("status") Integer status, @ApiParam("rebate_id") Long rebateId) {
    try {
      return repository.updateGoodsDetailStatusByRebateId(status, rebateId);
    } catch (Exception e) {
      throw new ServiceException(e);
    }
  }
