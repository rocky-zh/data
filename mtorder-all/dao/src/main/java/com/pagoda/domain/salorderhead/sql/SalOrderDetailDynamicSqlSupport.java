...
public class SalOrderDetailDynamicSqlSupport {
  ...
  public static SqlColumn<Long> conOrgId = salOrderDetailTable.conOrgId;
  public static SqlColumn<String> conOrgCode = salOrderDetailTable.conOrgCode;
  public static SqlColumn<String> conOrgName = salOrderDetailTable.conOrgName;
  public static SqlColumn<java.math.BigDecimal> batchQty = salOrderDetailTable.batchQty;
  public static SqlColumn<Integer> batchPolicy = salOrderDetailTable.batchPolicy;
