...
public class SalPreOrderDetailDynamicSqlSupport {
  ...
  public static SqlColumn<Long> conOrgId = salPreOrderDetailTable.conOrgId;
  public static SqlColumn<String> conOrgCode = salPreOrderDetailTable.conOrgCode;
  public static SqlColumn<String> conOrgName = salPreOrderDetailTable.conOrgName;
  public static SqlColumn<Integer> batchPolicy = salPreOrderDetailTable.batchPolicy;
  public static SqlColumn<java.math.BigDecimal> batchQty = salPreOrderDetailTable.batchQty;
