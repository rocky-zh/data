...
public class SalOrderHeadDynamicSqlSupport {
  ...
  public static SqlColumn<Long> orgOrgId = salOrderHeadTable.orgOrgId;
  public static SqlColumn<String> orgOrgCode = salOrderHeadTable.orgOrgCode;
  public static SqlColumn<String> orgOrgName = salOrderHeadTable.orgOrgName;
  public static SqlColumn<java.util.Date> commitTime = salOrderHeadTable.commitTime;
