...
public class TestApplication {
  // @EnableJpaRepositories(basePackages = "com.pagoda.test.repo",repositoryBaseClass =
  // PagodaJpaRepositoryImpl.class, repositoryFactoryBeanClass =
  // PagodaJpaRepositoryFactoryBean.class)
  // @ComponentScan({"com.pagoda.test.config"})
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    lemfb.setPackagesToScan("com.pagoda.test");
    return lemfb;
  }
