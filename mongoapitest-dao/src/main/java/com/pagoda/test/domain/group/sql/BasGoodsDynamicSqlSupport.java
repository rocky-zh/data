...
public class BasGoodsDynamicSqlSupport {
  ...
  public static SqlColumn<Integer> approvalStatus = basGoodsTable.approvalStatus;
  public static SqlColumn<Date> approvalAt = basGoodsTable.approvalAt;
  public static SqlColumn<String> approverName = basGoodsTable.approverName;
  public static SqlColumn<String> approverCode = basGoodsTable.approverCode;
  ...
  public static SqlColumn<Integer> isMulti = basGoodsTable.isMulti;
  ...
  public static SqlColumn<String> remark = basGoodsTable.remark;
  ...
  public static final class BasGoodsTable extends SqlTable {
    ...
    public final SqlColumn<Date> approvalAt = column("approval_at", JDBCType.DATE);
    public final SqlColumn<String> approverName = column("approver_name", JDBCType.VARCHAR);
    public final SqlColumn<String> approverCode = column("approver_code", JDBCType.VARCHAR);
