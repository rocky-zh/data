...
/**
 * 目录定义 1-level： tableid 包含：机构，供应商，客户，库房 2-level: 实体表定义
 *
...
public class BasCatDynamicSqlSupport {
  ...
  public static SqlColumn<String> codeTest = basCatTable.codeTest;
  ...
  public static final class BasCatTable extends SqlTable {
    ...
    public final SqlColumn<String> codeTest = column("code_test", JDBCType.VARCHAR);
