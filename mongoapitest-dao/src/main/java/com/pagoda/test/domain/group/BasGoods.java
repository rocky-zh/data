...
public class BasGoods extends BasGoodsDTO implements Serializable {
  ...
  @Column(name = "approval_status", columnDefinition = "int(11) COMMENT '审核状态'")
  ...
  @Column(name = "approval_at", columnDefinition = "datetime COMMENT '审核时间'")
  ...
  @Column(name = "approver_name", columnDefinition = "varchar(30) COMMENT '审核人name'")
  ...
  @Column(name = "approver_code", columnDefinition = "varchar(30) COMMENT '审核人code'")
