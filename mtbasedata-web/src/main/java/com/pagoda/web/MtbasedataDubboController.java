...
public class MtbasedataDubboController {
  ...
  static {
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.basGoodsBomDetailDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.basOrgOrgDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.basGoodsBomHeadDTO");
  }
  ...
  static {
    ...
    putInMap(API_PACKAGES, "com.pagoda.api.goods.basGoodsBomDetailService");
