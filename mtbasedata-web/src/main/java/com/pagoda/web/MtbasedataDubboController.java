...
public class MtbasedataDubboController {
  ...
  static {
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.ven.pur_org_ven_goodsDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.FindGoodsInDefineDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.bas_goods_unitDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.ven.bas_ven_rebate_headDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.cat.bas_cat_classDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.cat.bas_cat_class_extDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.SelectBasOrgForListDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.bas_org_goodsDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.cat.bas_catDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.bas_goods_class_code_ruleDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.SelectSubOrgGroupInfoDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.bas_goodsDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_org_orgDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.bas_goods_process_detailDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_org_bal_bankDTO");
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_org_depDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.ven.pur_org_venDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_org_cusDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.cat.bas_cat_class_relDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_org_balDTO");
    ...
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_districtDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_org_group_orgDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.ven.bas_ven_rebate_org_detailDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.unit.bas_unitDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.SelectBasOrgWithRelDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_orgDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_org_venDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.ent.sys_entDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.bas_goods_process_headDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.ven.bas_ven_rebate_goods_detailDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.ent.sys_ent_paramDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.goods.GetBasGoodsProcessHeadDetailsDTO");
    putInMap(DTO_PACKAGES, "com.pagoda.api.dto.org.bas_postDTO");
  }
