...
public class InvCheckStockHead extends InvCheckStockHeadDTO implements Serializable {
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "时间   COMMENT '调账日期'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "字符串   COMMENT '调账人Id'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "日期   COMMENT '盘点日期'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "长整型   COMMENT '盘点单号'"
  )
  private Long billNo;
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "字符串   COMMENT '{1:盘点单,2:封存单}'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "长整型   COMMENT '盘点商品数量'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "整型   COMMENT '{00-创建中,10-盘点中,20-调账完成,30-已撤销}'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "整型   COMMENT '{00-全盘，10局盘}'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "字符串   COMMENT '库房代码'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "长整型   COMMENT '库房Id'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "字符串   COMMENT '库房名称'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "长整型   COMMENT '核算期'"
  )
  ...
  @Column(
    ...
    precision = 0,
    scale = 0,
    columnDefinition = "布尔   COMMENT '入出库限制'"
  )
