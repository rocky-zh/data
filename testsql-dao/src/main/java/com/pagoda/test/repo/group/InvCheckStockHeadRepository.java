...
/**
 * InvCheckStockHead 数据访问接口
 *
 * @author PagodaGenerator
 * @generated
 */
public interface InvCheckStockHeadRepository
    extends InvCheckStockHeadRepositoryCustom, PagodaJpaRepository<InvCheckStockHead, Long> {
