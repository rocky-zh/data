package com.pagoda.domain.driverdata.sql;
...
public class BasDriverDynamicSqlSupport {
  ...
  public static SqlColumn<Long> entId = basDriverTable.entId;
  public static SqlColumn<Long> conOrgId = basDriverTable.conOrgId;
  ...
  public static final class BasDriverTable extends SqlTable {
    ...
    public final SqlColumn<Long> conOrgId = column("conOrgId", JDBCType.BIGINT);
