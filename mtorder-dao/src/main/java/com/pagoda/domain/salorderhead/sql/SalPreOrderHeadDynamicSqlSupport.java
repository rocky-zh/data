...
public class SalPreOrderHeadDynamicSqlSupport {
  ...
  public static SqlColumn<java.util.Date> entryDate = salPreOrderHeadTable.entryDate;
  ...
  public static final class SalPreOrderHeadTable extends SqlTable {
    ...
    public final SqlColumn<java.util.Date> entryDate = column("entry_date", JDBCType.DATE);
