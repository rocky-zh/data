...
public class SalPreOrderHeadDynamicSqlSupport {
  ...
  public static SqlColumn<Long> orgOrgId = salPreOrderHeadTable.orgOrgId;
  public static SqlColumn<String> orgOrgCode = salPreOrderHeadTable.orgOrgCode;
  public static SqlColumn<String> orgOrgName = salPreOrderHeadTable.orgOrgName;
  public static SqlColumn<java.util.Date> commitTime = salPreOrderHeadTable.commitTime;
