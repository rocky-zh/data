...
public class PriceCatalogSalHeadDynamicSqlSupport {
  ...
  public static SqlColumn<Long> conOrgId = priceCatalogSalHeadTable.conOrgId;
  public static SqlColumn<String> conOrgCode = priceCatalogSalHeadTable.conOrgCode;
  public static SqlColumn<String> conOrgName = priceCatalogSalHeadTable.conOrgName;
