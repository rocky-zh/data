...
public class SalConsignOutExceptionLogDynamicSqlSupport {
  ...
  public static SqlColumn<java.sql.Timestamp> consignTime =
      salConsignOutExceptionLogTable.consignTime;
  ...
  public static SqlColumn<java.sql.Timestamp> auditTime = salConsignOutExceptionLogTable.auditTime;
