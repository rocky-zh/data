...
public class PurOrgVenRepositoryImpl extends BaseRepositoryCustomImpl<PurOrgVen, Long>
  ...
  public Page<PurOrgVenDTO> findBy(
      ...
      @Param("venClassId") Long venClassId,
      @Param("venClassName") String venClassName,
      @Param("venClassCode") String venClassCode,
    ...
    obj.setVenClassId(venClassId);
    obj.setVenClassName(venClassName);
    obj.setVenClassCode(venClassCode);
