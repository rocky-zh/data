 ...
 */
@NoRepositoryBean
public interface BaseSalConsignReturnHeadRepository
   ...
   */
  @SqlTemplate(
    name = "findEntryCompletedReturnHead",
    sql =
        "select id,seqno,arr_org_code,arr_org_name,cus_org_code,cus_org_name,return_type,return_date,return_qty, total_tax_amt, total_return_amt,total_stockin_amt,status,creator_name,created_at,modifier_name,last_modified_at,remark,note,  transit_line_no,print_count,version from sal_consign_return_head where deleted = 0 and status >= 20 {{#status}} and status=:status{{/status}}  {{#seqno}} and seqno like '{{seqno}}%'{{/seqno}}  {{#arr_org_code}} and arr_org_code=:arr_org_code{{/arr_org_code}} {{#arr_org_name}} and arr_org_name=:arr_org_name{{/arr_org_name}}  {{#cus_org_code}} and cus_org_code=:cus_org_code{{/cus_org_code}} {{#cus_org_name}} and cus_org_name=:cus_org_name{{/cus_org_name}}  {{#return_type}} and return_type=:return_type{{/return_type}}  {{#transit_line_no}} and transit_line_no=:transit_line_no{{/transit_line_no}}  {{#pre_arrival_date1}} and pre_arrival_date>=:pre_arrival_date1{{/pre_arrival_date1}}  {{#pre_arrival_date2}} and pre_arrival_date<=:pre_arrival_date2{{/pre_arrival_date2}}  {{#creator_org_code_exists}} and creator_org_code in ({{#creator_org_code}}{{^-first}}, {{/-first}}\"{{this}}\"{{/creator_org_code}}) {{/creator_org_code_exists}}"
  )
  Page<SalConsignReturnHeadDTO> findEntryCompletedReturnHead(
      @Param("status") Integer status,
      @Param("seqno") String seqno,
      @Param("arr_org_code") String arrOrgCode,
      @Param("arr_org_name") String arrOrgName,
  ...
  List<SalConsignReturnHeadDTO> findEntryCompletedReturnHead(
      @Param("status") Integer status,
      @Param("seqno") String seqno,
      @Param("arr_org_code") String arrOrgCode,
      @Param("arr_org_name") String arrOrgName,
