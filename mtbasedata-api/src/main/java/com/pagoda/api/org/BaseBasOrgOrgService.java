 ...
 */
@Validated
public interface BaseBasOrgOrgService {
  ...
  BasOrgOrgDTO create(@ApiParam(value = "entity", required = true) @Valid BasOrgOrgDTO entity)
      throws ServiceException;
  ...
  Iterable<BasOrgOrgDTO> batchCreate(
  ...
  BasOrgOrgDTO update(@ApiParam(value = "entity", required = true) BasOrgOrgDTO entity)
      throws ServiceException;
  ...
  Iterable<BasOrgOrgDTO> batchUpdate(
  ...
  BasOrgOrgDTO getById(@ApiParam(value = "id", required = true) Long id) throws ServiceException;
  ...
  Iterable<BasOrgOrgDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
