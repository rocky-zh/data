 ...
 */
@Validated
public interface BaseBasOrgDepService {
  ...
  BasOrgDepDTO create(@ApiParam(value = "entity", required = true) @Valid BasOrgDepDTO entity)
      throws ServiceException;
  ...
  Iterable<BasOrgDepDTO> batchCreate(
  ...
  BasOrgDepDTO update(@ApiParam(value = "entity", required = true) BasOrgDepDTO entity)
      throws ServiceException;
  ...
  Iterable<BasOrgDepDTO> batchUpdate(
  ...
  BasOrgDepDTO getById(@ApiParam(value = "id", required = true) Long id) throws ServiceException;
  ...
  Iterable<BasOrgDepDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
