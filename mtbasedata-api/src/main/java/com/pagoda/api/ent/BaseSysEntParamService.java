 ...
 */
@Validated
public interface BaseSysEntParamService {
  ...
  SysEntParamDTO create(@ApiParam(value = "entity", required = true) @Valid SysEntParamDTO entity)
      throws ServiceException;
  ...
  Iterable<SysEntParamDTO> batchCreate(
  ...
  SysEntParamDTO update(@ApiParam(value = "entity", required = true) SysEntParamDTO entity)
      throws ServiceException;
  ...
  Iterable<SysEntParamDTO> batchUpdate(
  ...
  SysEntParamDTO getById(@ApiParam(value = "id", required = true) Long id) throws ServiceException;
  ...
  Iterable<SysEntParamDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
