...
@ApiModel(value = "FindGoodOnCatClassDTO", description = "分类关系->根据目录分类查找商品")
@EntityFeature(
  entityName = "FindGoodOnCatClassDTO",
  persistent = false,
  requestUrl = "",
  tableMultiSelect = false
)
public class FindGoodOnCatClassDTO implements Serializable {
  @FieldMeta(
    name = "goodsOrigin",
    scene = "",
    nameCN = "商品产地",
