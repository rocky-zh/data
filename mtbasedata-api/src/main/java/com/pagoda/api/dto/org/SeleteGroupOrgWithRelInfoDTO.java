...
@ApiModel(value = "SeleteGroupOrgWithRelInfoDTO", description = "选择框查询虚拟机构组 子机构信息")
@EntityFeature(
  entityName = "SeleteGroupOrgWithRelInfoDTO",
  persistent = false,
  requestUrl = "",
  tableMultiSelect = false
)
public class SeleteGroupOrgWithRelInfoDTO implements Serializable {
  @FieldMeta(
    name = "isCus",
    scene = "",
