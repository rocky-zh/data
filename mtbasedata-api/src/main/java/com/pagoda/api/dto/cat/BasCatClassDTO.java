...
@ApiModel(
  value = "BasCatClassDTO",
  description = "目录分类表:全系统多维度树形结构表[包含：机构，供应商，部门，客户，库房...等]  1-level： tab"
)
@EntityFeature(
...
public class BasCatClassDTO extends AbstractDTO implements Serializable {
  ...
  @ApiModelProperty(
    ...
    value = "父目录分类代码[冗余]",
    dataType = "",
    notes = "5b35f6ae9d2feff19b5287f5"
  )
  ...
  @ApiModelProperty(
    ...
    value = "父目录分类名称[冗余]",
    dataType = "",
    notes = "5b35f6ae9d2feff19b528802"
  )
  ...
  @ApiModelProperty(
    ...
    value = "层级数",
    dataType = "",
    notes = "5b35f6ae9d2feff19b52880a"
  )
  ...
  @ApiModelProperty(
    ...
    value = "是否子节点",
    dataType = "",
    notes = "5b35f6ae9d2feff19b528808"
  )
  ...
  public static class Getters {
    ...
    public static final Function<BasCatClassDTO, String> _creatorOrgCode =
    ...
    public static final Function<BasCatClassDTO, String> _modifierOrgCode =
    ...
    public static final Function<BasCatClassDTO, Long> _parentCatClassId =
        o -> o.getParentCatClassId();
    public static final Function<BasCatClassDTO, String> _parentCatClassCode =
        o -> o.getParentCatClassCode();
    public static final Function<BasCatClassDTO, String> _parentCatClassName =
        o -> o.getParentCatClassName();
