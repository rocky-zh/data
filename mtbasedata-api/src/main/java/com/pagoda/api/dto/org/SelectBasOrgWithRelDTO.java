...
@ApiModel(value = "SelectBasOrgWithRelDTO", description = "往来单位关系定义查询 分类目录下的数据")
@EntityFeature(
  entityName = "SelectBasOrgWithRelDTO",
  persistent = false,
  requestUrl = "",
  tableMultiSelect = false
)
public class SelectBasOrgWithRelDTO implements Serializable {
  @FieldMeta(
    name = "isCus",
    scene = "",
