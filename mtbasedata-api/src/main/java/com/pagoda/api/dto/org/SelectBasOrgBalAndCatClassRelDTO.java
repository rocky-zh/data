...
@ApiModel(value = "SelectBasOrgBalAndCatClassRelDTO", description = "所属往来单位 链目录表 选择弹框查询")
@EntityFeature(
  entityName = "SelectBasOrgBalAndCatClassRelDTO",
  persistent = false,
  requestUrl = "",
  tableMultiSelect = false
)
public class SelectBasOrgBalAndCatClassRelDTO implements Serializable {
  @FieldMeta(
    name = "creatorOrgCode",
    scene = "",
    nameCN = "录入人机构代码",
