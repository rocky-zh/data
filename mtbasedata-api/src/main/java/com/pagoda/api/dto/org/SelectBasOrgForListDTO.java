...
@ApiModel(value = "SelectBasOrgForListDTO", description = "往来单位定义列表模糊查询")
@EntityFeature(
  entityName = "SelectBasOrgForListDTO",
  persistent = false,
  requestUrl = "",
  tableMultiSelect = false
)
public class SelectBasOrgForListDTO implements Serializable {
  @FieldMeta(
    name = "isCus",
    scene = "",
