 ...
 */
@Validated
public interface BaseBasCatClassExtService {
  ...
  Iterable<BasCatClassExtDTO> batchCreate(
  ...
  BasCatClassExtDTO update(@ApiParam(value = "entity", required = true) BasCatClassExtDTO entity)
      throws ServiceException;
  ...
  Iterable<BasCatClassExtDTO> batchUpdate(
  ...
  BasCatClassExtDTO getById(@ApiParam(value = "id", required = true) Long id)
      throws ServiceException;
  ...
  Iterable<BasCatClassExtDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
