 ...
 */
@Validated
public interface BaseBasGoodsBomHeadService {
  ...
  Iterable<BasGoodsBomHeadDTO> batchCreate(
  ...
  BasGoodsBomHeadDTO update(@ApiParam(value = "entity", required = true) BasGoodsBomHeadDTO entity)
      throws ServiceException;
  ...
  Iterable<BasGoodsBomHeadDTO> batchUpdate(
  ...
  BasGoodsBomHeadDTO getById(@ApiParam(value = "id", required = true) Long id)
      throws ServiceException;
  ...
  Iterable<BasGoodsBomHeadDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
