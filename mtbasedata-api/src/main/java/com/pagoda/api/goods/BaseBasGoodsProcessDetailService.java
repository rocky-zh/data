 ...
 */
@Validated
public interface BaseBasGoodsProcessDetailService {
  ...
  BasGoodsProcessDetailDTO create(
  ...
  Iterable<BasGoodsProcessDetailDTO> batchCreate(
  ...
  BasGoodsProcessDetailDTO update(
  ...
  Iterable<BasGoodsProcessDetailDTO> batchUpdate(
  ...
  BasGoodsProcessDetailDTO getById(@ApiParam(value = "id", required = true) Long id)
      throws ServiceException;
  ...
  Iterable<BasGoodsProcessDetailDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
