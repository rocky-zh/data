 ...
 */
@Validated
public interface BaseBasGoodsUnitService {
  ...
  BasGoodsUnitDTO create(@ApiParam(value = "entity", required = true) @Valid BasGoodsUnitDTO entity)
      throws ServiceException;
  ...
  Iterable<BasGoodsUnitDTO> batchCreate(
  ...
  BasGoodsUnitDTO update(@ApiParam(value = "entity", required = true) BasGoodsUnitDTO entity)
      throws ServiceException;
  ...
  Iterable<BasGoodsUnitDTO> batchUpdate(
  ...
  BasGoodsUnitDTO getById(@ApiParam(value = "id", required = true) Long id) throws ServiceException;
  ...
  Iterable<BasGoodsUnitDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
  ...
  Page<BasGoodsUnitDTO> findByExample(
