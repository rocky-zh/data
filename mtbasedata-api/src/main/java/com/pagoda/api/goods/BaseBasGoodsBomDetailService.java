 ...
 */
@Validated
public interface BaseBasGoodsBomDetailService {
  ...
  Iterable<BasGoodsBomDetailDTO> batchCreate(
  ...
  Iterable<BasGoodsBomDetailDTO> batchUpdate(
  ...
  BasGoodsBomDetailDTO getById(@ApiParam(value = "id", required = true) Long id)
      throws ServiceException;
  ...
  Iterable<BasGoodsBomDetailDTO> batchGetByIds(@ApiParam("idList") List<Long> idList)
      throws ServiceException;
